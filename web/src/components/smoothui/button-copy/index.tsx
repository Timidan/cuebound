...
import { Check, Copy, CircleNotch } from "@phosphor-icons/react";
...
export interface ButtonCopyProps {
  className?: string;
  disabled?: boolean;
  /** Accessible name, e.g. "Copy the brief reference". */
  label?: string;
  duration?: number;
  idleIcon?: ReactNode;
  ...
  return (
    <div className="flex shrink-0 justify-center">
      <button
        ...
        aria-live="polite"
        className={`relative min-h-[44px] w-auto min-w-[44px] cursor-pointer overflow-hidden rounded-full border bg-background p-3 transition-transform enabled:active:scale-[0.96] focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:opacity-50 ${className}`}
        disabled={
