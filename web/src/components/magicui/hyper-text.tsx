// Vendored from Magic UI (magicui.design/r/hyper-text.json), the React original of the Inspira UI effect of the same name.
import {
  useEffect,
  useRef,
  useState,
...
interface HyperTextProps extends Omit<MotionProps, "children"> {
  ...
  /** CueBound: keep the text's own case (for hashes and code) instead of upper-casing it. */
