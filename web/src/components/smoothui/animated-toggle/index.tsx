...
const AnimatedToggle = ({
  ...
  return (
    <button
      ...
      aria-label={label}
      className={cn(
        "relative inline-flex shrink-0 cursor-pointer items-center rounded-full p-0.5 transition-colors pointer-coarse:after:absolute pointer-coarse:after:-inset-3",
