...
export default function AnimatedTabs({
  ...
  const getTabStyles = (isActive: boolean) =>
    cn(
      "relative z-10 flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap px-4 py-2 font-medium text-sm transition-[color,scale] active:scale-[0.96]",
  ...
  const getIndicatorStyles = () =>
    cn(
      ...
      variant === "segment" &&
        "inset-0 rounded-[0.5rem] border border-border bg-background shadow-sm"
    );
